...
#define MAX_SHCT 31
#define SHCT_SIZE_BITS (11+LOGMULT)
...
#define SAMPLED_SET(set) (bits(set, 0 , (6+LOGMULT)) == bits(set, ((unsigned long long)log2(LLC_SETS) - (6+LOGMULT)), (6+LOGMULT)) )

// Sampler to track 8x cache history for sampled sets
// 2800 entris * 4 bytes per entry = 11.2KB
#define SAMPLED_CACHE_SIZE 2800*(1<LOGMULT)
